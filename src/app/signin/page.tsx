...
const SignIn = () => {
  ...
  if (Context) {
    // localStorage.setItem("accessToken", Context?.user.accessToken)
    redirect("/")
  }
  return (
    <div className="max-w-[280px] mx-auto">
      <div className="flex flex-col items-center mt-[10vh]">
        ...
        <form>
          <input
            type="text"
            className="w-full px-6 py-3 mb-2 border border-slate-600 rounded-lg font-medium outline-none"
            placeholder="Email"
          />
          <input
            type="password"
        ...
        <p className="text-center mt-3 text-[14px]">
          ...
          <a href="/signup" className="text-gray-600 ml-2">
            Create one
          </a>
        </p>
        {/* <p className="text-center mt-3 text-[14px]">
